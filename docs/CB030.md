...
entscheiden, welches Gerät gemeint ist — als einfache if/else-Kette, **RAM zuerst geprüft**
(Performance: das ist der mit Abstand häufigste Fall):

```
wenn NICHT remapped:
    adr < 0x0800_0000           → ROM, gespiegelt (adr modulo ROM-Größe)
