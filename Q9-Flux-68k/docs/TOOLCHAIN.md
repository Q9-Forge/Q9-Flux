...
| Emscripten Referenz-Toolchain (emcc) | latest (emsdk) | `C:\Users\foell\emsdk` | WASM/Browser-Build |
...
| Emscripten Referenz-Toolchain | **noch nicht installiert** | — | wasm-Build hier noch nicht möglich |
...
| Emscripten Referenz-Toolchain (emcc) | 6.0.2 (latest, 2026-07-04) | `~/emsdk` | WASM/Browser-Build |
