# PROJECT_VISION_ARCHIV.md — Q9 (archiviert 2026-07-31)

> **Archiviert.** Beschreibt Q9s allererste Vision (eigener Mini-Kernel,
> WASM-Browser-Ziel, Modulsystem) aus der Projektphase 2.-4. Juli 2026. Diese
> Vision wurde seither nicht weiterverfolgt — der zugehoerige Code (eigener
> Kernel, wasm3-Runtime, Browser-Frontend) wurde nach `Q9RESUME-Kernel`
> ausgelagert (mit voller Historie). Q9-Flux ist seitdem faktisch der
> CB030/68k-Hardware-Emulator fuer echtes Microware-OS-9.
>
> **Weiterhin gueltig** sind die Entscheidungen **E12** (Musashi als
> CPU-Emulator), **E13** (Windows-HAL-Konsolencodes) und **E14**
> (Geraete-Registry `devreg.c`) — die betreffen den CB030-Emulator direkt.
> Alles andere (E1-E11, die gesamte Vision/Architektur/Phasenplan) ist
...
| E7 | Syscall-Nummern, Fehlercodes und Registerkonventionen = OS-9 (Quelle: REF funcs.h/errno.h); virtueller Registersatz im 68k-Layout (d0-d7/a0-a7), Spez. in docs/SYSCALLS.md | OS-9-Software (68k+6809) mechanisch abbildbar, Runtimes werden dünne Register-Mapper |
