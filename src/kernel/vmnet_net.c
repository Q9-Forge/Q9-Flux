...
#define QV_GATEWAY   "10.0.0.2"                       /* vmnet-Gateway = alte Mini-NAT-Adresse    */
#define QV_DHCP_END  "10.0.0.254"                     /* DHCP-Bereich (Gast 10.0.0.1 ist statisch)*/
#define QV_NETMASK   "255.255.255.0"
