//════════════════════════════════════════════════════════════════════════════════════════════════
// File:   fat16.h                                                                        Ver. 1.10
// Owner:  AF
// Desc.:  Q9 FAT16-File-Manager, lesend + schreibend (Phase 3.3/3.4). Nur Superfloppy-Images
//         (Boot-Sektor bei LBA 0 des Block-Device, KEINE Partitionstabelle) — Interop-Test: am
//         Mac mit `newfs_msdos -F 16` formatiert und befuellt, aus Q9 heraus gelesen; seit 3.4
//         auch umgekehrt: von Q9 geschrieben, am Mac (bzw. per Python-Nachvalidierung, siehe
//         test/07_test_fat16_write.py) gelesen (ARBEITSPLAN.md). Layout aus oeffentlich
//         dokumentierter FAT16-Spezifikation (Microsoft "FAT: General Overview of On-Disk
//         Format") nachgebaut — KEIN Copyright-Code uebernommen. Als Design-Referenz fuer den
//         File-Manager-Schnitt diente "OS-9 Insights" (Dibble, nur Konzept gelesen, nicht
//         abgeschrieben).
//
...
// 26-07-04│ 1.10 │ 3.4: q9_fat16_fm um write erweitert; create/makdir/remove jetzt echt    │ CF
//         │      │ implementiert (FAT-Ketten allozieren/freigeben, neue 8.3-Eintraege)     │
//═════════╧══════╧════════════════════════════════════════════════════════════════════════╧══════
#ifndef Q9_FAT16_H
#define Q9_FAT16_H
