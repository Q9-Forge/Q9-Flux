...
Fuer die Groesse verwendet OS-9 derzeit termcap `co`/`li` mit 80x24 als
Rueckfallwert. Eine versuchsweise ANSI-Abfrage per `CSI 6 n` wurde wieder
entfernt: Auf der emulierten Konsole teilt sie sich den langsamen Eingabekanal
mit dem Editor und kann Antwortbytes als Benutzereingabe zuruecklassen.
